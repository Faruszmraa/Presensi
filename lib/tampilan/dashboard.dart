...
import 'package:flutter_application_1/tampilan/rekapabsen.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Future<void> getUserData() async {
    ...
    String? imgUrl = prefs.getString('imgProfile') ?? "not found";
  ...
  // Metode untuk menyimpan status check-in
  Future <void> saveStatusMasuk() async {
    final prefs = await SharedPreferences.getInstance();
    prefs.setBool('isMasuk', isMasuk);
  }

  // Metode untuk membuat status check-in/check-out
  ...
  Future <void> recordAttedance() async{
        ...
        child: Column(
          children: [
           ...
           FutureBuilder<Presensi>(
            future:fetchPresensi(nik, getToday()),
                          ...
                          children: [
                            Row(children: [
                              Container(
                                ...
                                child: SvgPicture.asset('assets/svgs/login_outlined'),
                              ),
                              const SizedBox(width: 10,),
                              Text(
                                'Masuk',
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: GoogleFonts.lexend(
                                fontSize: 22,
                                fontWeight: FontWeight.bold,
                                color: const Color(0xFF10317),
                              ),
                            ),
                            Text(
                              getPresenceEntryStatus(data?.jamKeluar??'-'),
                              style: GoogleFonts.lexend(
                                fontSize: 16,
                                color: const Color(0xFF1011317),
                              ),),
                          ],
                        ),
                        //
                    ...
                    child: Container(
                      decoration: const BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage('asset/images/bg_izin.png'),
                          fit: BoxFit.cover,
                        ),
                      ),
                      child: Padding(
                ...
                Expanded(
                  child: Card(
                    ...
                    child: Container(
                      decoration: const BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage('asset/images/bg_cuti.png'),
                          fit: BoxFit.cover,
                        ),
                      ),
                      child: Padding(
